...
ir_task = 'denoise' 
net_name = 'proposed' # same as model_zoo final dir name

# python TEST_GAUSSIAN.py --opt ./options/denoise/train_PROPOSED_denoise_15.json --test_set CBSD68 --noise 15
# python TEST_GAUSSIAN.py --opt ./options/denoise/train_PROPOSED_denoise_15.json --test_set Kodak24 --noise 15
# python TEST_GAUSSIAN.py --opt ./options/denoise/train_PROPOSED_denoise_15.json --test_set McMaster --noise 15
# python TEST_GAUSSIAN.py --opt ./options/denoise/train_PROPOSED_denoise_15.json --test_set urban100 --noise 15
