...
class FastLeFF(nn.Module):
    ...
    def __init__(self, dim=32, hidden_dim=128, act_layer=nn.GELU, drop=0.):
        ...
        self.linear1 = nn.Sequential(nn.Linear(dim, hidden_dim),
                                     act_layer())
        self.dwconv = self.dwconv = nn.Sequential(nn.Conv2d(in_channels=hidden_dim,out_channels=hidden_dim,kernel_size=3,stride=1,padding=1,groups=hidden_dim,bias=False),
                                                  act_layer() )
